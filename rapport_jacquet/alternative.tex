...
\question{A simple computation} Unformally, we have this expression for $\lambda(s)$ 
...
and after the expression for $\Delta'(s)$
...
This code that computes it can be found in \ref{app:comp_lam2}.
