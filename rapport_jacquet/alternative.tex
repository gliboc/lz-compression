...
Therefore $\sqrt{\Delta(-1)} = 2 - p_{0 0} - p_{1 1} = p_{0 1} + p_{1 0} $, 
and we also verify that  $\lambda(-1) = 1 = \f{ p_{0 0} + p_{1 1} + \sqrt{\Delta(-1)}}{2} $}
...
\centers{$ \Delta'(s) = - 2 \ln p_{0 0} \poo - 2 \ln p_{1 1} \pii
                        + 2 \ln (p_{0 0} p_{1 1}) \pooii 
                        - 4 \ln (p_{0 1} p_{1 0}) \poiio $}
and 
\centers{$ \Delta'(-1) = - 2 \ln p_{0 0} p_{0 0} - 2 \ln p_{1 1} p_{1 1}
...
\centers{$ \ddot{\lambda}(s) =
                \f{ \ln^2 p_{0 0} \poo + \ln^2 p_{1 1} \pii
